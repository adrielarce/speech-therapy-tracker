 ...
 * - static color
 */
export declare const getInheritedColorGenerator: <Datum = any>(config: InheritedColorConfig<Datum>, theme?: Partial<{
    crosshair: Partial<{
        line: Partial<{
            stroke: string;
            strokeWidth: number;
...
export declare const useInheritedColor: <Datum = any>(config: InheritedColorConfig<Datum>, theme?: Partial<{
    crosshair: Partial<{
        line: Partial<{
            stroke: string;
            strokeWidth: number;
